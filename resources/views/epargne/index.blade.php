...
<x-app-layout>
    <div class=" pb-20 text-sm">
        ...
        <!-- Boutons -->
        <div class="flex items-center space-x-0 justify-center gap-2 p-2 shadow-lg shadow-black">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
            @forelse ($epargnes as $epargne)
                <div
                    class="bg-gradient-to-r from-yellow-300 to-orange-300 shadow-lg shadow-black p-4 transition-transform transform hover:scale-105 ">
                    ...
                    <button onclick="openModal('modal-{{ $epargne->id }}')"
                        class="w-full bg-gray-600 text-white rounded-lg px-4 py-2 hover:bg-blue-700 transition">
                ...
                <div id="modal-{{ $epargne->id }}"
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-lg w-80">
                        ...
                        <form action="{{ route('epargne.user.store') }}" method="POST">
                            ...
                            <button type="submit"
                                class="w-full bg-gray-600 text-white rounded-lg px-4 py-2 hover:bg-blue-700 transition flex items-center justify-center">
