...
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between font-semibold text-xl text-green-300 leading-tight">
            ...
            <a href="{{ route('admin.utilisateur.actualiser', ['user' => $compte?->user->id, 'pack' => $compte?->pack->id]) }}"
            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-100">
                    <div class="bg-gray-700 p-6 rounded-lg shadow-md">
                        ...
                        <p class="text-white underline mb-4">Solde actuel: {{ $compte->solde_actuel }} FCFA</p>
                    </div>
