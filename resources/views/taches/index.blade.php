<x-app-layout>
    <div class="container mx-auto pb-1">
        ...
        <h2 class="text-xl font-bold text-white mb-4 px-4 bg-gray-500 rounded-lg p-3 mx-2 mt-2">
        ...
        <h2 class="text-xl font-bold text-white mb-4 text-center bg-gray-500 rounded-lg p-3 mx-2">
