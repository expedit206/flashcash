    ...
    <div class="container mx-auto  pb-16">
        ...
        <div id="content">
            <div id="niveau1" class="tab-content mb-6 px-4">
                ...
                <p class="text-gray-700 mb-2 font-semibold">Total Investissement : <span class="text-yellow-500">{{ number_format($totalFirstInvestmentNiveau1, 2, ',', ' ') }} XAF</span>
                </p>
                
                <p class="text-gray-700 mb-2 font-semibold">Gains accumulés : <span class="text-yellow-500">{{ config('parrainage.taux_interet.vip1') * $totalFirstInvestmentNiveau1 / 100 }} XAF</span>
            ...
            <div id="niveau2" class="tab-content hidden mb-6 px-4">
                <p class="text-gray-700 mb-2 font-semibold">Total Investissement : <span class="text-yellow-500">{{ number_format($totalFirstInvestmentNiveau2, 2, ',', ' ') }} XAF</span></p>
                <p class="text-gray-700 mb-2 font-semibold">Gains accumulés : <span class="text-yellow-500">{{ config('parrainage.taux_interet.vip2') * $totalFirstInvestmentNiveau2 / 100 }} XAF</span>
            ...
            <div id="niveau3" class="tab-content hidden mb-6 px-4">
                <p class="text-gray-700 mb-2 font-semibold">Total Investissement : <span class="text-yellow-500">{{ number_format($totalFirstInvestmentNiveau3, 2, ',', ' ') }} XAF</span></p>
                <p class="text-gray-700 mb-2 font-semibold">Gains accumulés : <span class="text-yellow-500">{{ config('parrainage.taux_interet.vip3') * $totalFirstInvestmentNiveau3 / 100 }} XAF</span>
